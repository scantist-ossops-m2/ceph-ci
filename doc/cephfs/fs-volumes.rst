...
* pools: Attributes of data and metadata pools
        * avail: The amount of free space available in GB
        * used: The amount of storage consumed in GB
        * name: Name of the pool
* mon_addrs: List of monitor addresses
* size: Current used size of the CephFS volume in bytes
