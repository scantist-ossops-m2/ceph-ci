...
To dump the values to stdout without creating a curses display use::

  $ cephfs-top --dump

To dump the values of the given filesystem to stdout without creating a curses display use::
