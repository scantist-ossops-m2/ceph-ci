...
.. note:: Note that confirmation flag above is optional because it is only
   required when the MDS is active and has health warning MDS_HEALTH_TRIM
   or MDS_HEALTH_CACHE_OVERSIZE.
