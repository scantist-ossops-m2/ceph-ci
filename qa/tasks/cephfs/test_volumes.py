...
class TestSubvolumeSnapshots(TestVolumesHelper):
    ...
    def test_clean_stale_subvolume_snapshot_metadata(self):
        ...
        self.mount_a.run_shell(['cp', '-p', meta_path, tmp_meta_path], sudo=True)
        ...
        self.mount_a.run_shell(['cp', '-p', tmp_meta_path, meta_path], sudo=True)
        ...
        self.mount_a.run_shell(['rm', '-f', tmp_meta_path], sudo=True)
