...
class TestMDSMetrics(CephFSTestCase):
    ...
    def test_query_client_ip_filter(self):
        ...
        client_matadata = metrics['client_metadata'][TestMDSMetrics.TEST_FS_NAME]
        # pick an random client
        ...
        for i in metrics['client_metadata'][TestMDSMetrics.TEST_FS_NAME]:
            self.assertEqual(client_ip, metrics['client_metadata'][TestMDSMetrics.TEST_FS_NAME][i]['IP'])
    ...
    def test_perf_stats_stale_metrics(self):
        ...
        global_metrics = metrics['global_metrics'][TestMDSMetrics.TEST_FS_NAME]
        ...
        try:
            ...
            global_metrics = metrics_new['global_metrics'][TestMDSMetrics.TEST_FS_NAME]
