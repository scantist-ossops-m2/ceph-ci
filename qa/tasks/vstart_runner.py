...
tasks.cephfs.kernel_mount.KernelMount = typing.cast(typing.Type[tasks.cephfs.kernel_mount.KernelMountBase], LocalKernelMount)
...
tasks.cephfs.fuse_mount.FuseMount = typing.cast(typing.Type[tasks.cephfs.fuse_mount.FuseMountBase], LocalFuseMount)
