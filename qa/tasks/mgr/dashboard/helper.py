...
class DashboardTestCase(MgrTestCase):
    ...
    @classmethod
    def _get(cls, url, params=None, version=DEFAULT_API_VERSION, set_cookies=False, headers={}):
        return cls._request(url, 'GET', params=params, version=version, set_cookies=set_cookies, headers=headers)
