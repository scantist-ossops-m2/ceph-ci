...
GTEST_OUTPUT="xml:/home/ubuntu/cephtest/archive/gtest_xml_report.xml"
...
do
	...
	bash -o pipefail -exc "ceph_test_rados_$f --gtest_output=$GTEST_OUTPUT $color 2>&1 | tee ceph_test_rados_$ff.log | sed \"s/^/$r: /\"" &
	pid=$!
