...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${image1} 'up+replaying' '"entries_behind_primary":0.*primary_position'
if [ -z "${RBD_MIRROR_USE_RBD_MIRROR}" ]; then
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
compare_images ${POOL} ${image}
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${image} 'up+stopped'
wait_for_status_in_pool_dir ${CLUSTER2} ${POOL} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
compare_images ${POOL} ${image}
compare_images ${POOL} ${image} ${CLUSTER2} ${CLUSTER3}
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${force_promote_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER2} ${POOL} ${force_promote_image} 'up+stopped'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${force_promote_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${PARENT_POOL} ${parent_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${PARENT_POOL} ${parent_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${clone_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${clone_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${dp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${dp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
for i in ${image2} ${image4}; do
  ...
  wait_for_image_replay_started ${CLUSTER3} ${POOL} ${i}
  wait_for_replay_complete ${CLUSTER1} ${CLUSTER2} ${POOL} ${i}
  wait_for_replay_complete ${CLUSTER3} ${CLUSTER2} ${POOL} ${i}
  compare_images ${POOL} ${i}
  compare_images ${POOL} ${i} ${CLUSTER2} ${CLUSTER3}
done
...
for local_cluster in ${CLUSTERS}; do
  for remote_cluster in ${CLUSTERS}; do
    if [ "${local_cluster}" != "${remote_cluster}" ]; then
      peer_add ${local_cluster} ${pool} ${remote_cluster}
    fi
  done
done
...
wait_for_replay_complete ${CLUSTER3} ${CLUSTER2} ${POOL} ${rdp_image}
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${rdp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${rdp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
for cluster in ${CLUSTERS}; do
...
wait_for_image_present ${CLUSTER3} ${POOL} ${rdp_image} 'deleted'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL}/${NS1} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL}/${NS1} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL}/${NS2} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL}/${NS2} ${image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL}/${NS1} ${dp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL}/${NS1} ${dp_image} 'up+replaying' '"entries_behind_primary":0.*primary_position'
...
wait_for_image_replay_started ${CLUSTER1} ${POOL} ${image}
wait_for_replay_complete ${CLUSTER1} ${CLUSTER2} ${POOL} ${image}
test_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER1}
test_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER3}
disconnect_image ${CLUSTER2} ${POOL} ${image}
test_empty_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER1}
test_empty_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER3}
wait_for_image_replay_stopped ${CLUSTER1} ${POOL} ${image}
wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${image} 'up+error' 'disconnected'
wait_for_status_in_pool_dir ${CLUSTER3} ${POOL} ${image} 'up+error' 'disconnected'
...
test_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER1}
compare_images ${POOL} ${image}
request_resync_image ${CLUSTER3} ${POOL} ${image} image_id
wait_for_image_present ${CLUSTER3} ${POOL} ${image} 'deleted' ${image_id}
wait_for_image_present ${CLUSTER3} ${POOL} ${image} 'present'
wait_for_image_replay_started ${CLUSTER3} ${POOL} ${image}
wait_for_replay_complete ${CLUSTER3} ${CLUSTER2} ${POOL} ${image}
test_mirror_journal_position ${CLUSTER2} ${POOL} ${image} ${CLUSTER3}
...
if can_execute ${CLUSTER3}; then
    ...
    image_c2=primary_c2
    image_c3=primary_c3
    create_image ${CLUSTER2} ${POOL} ${image_c2}
    create_image ${CLUSTER3} ${POOL} ${image_c3}
