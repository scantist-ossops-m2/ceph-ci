...
class PgScrubber : public ScrubPgIF,
 ...
 private:
  ...
  using asok_fn_t = int (PgScrubber::*)(
      Formatter* f,
      std::string_view param,
  ...
  int dbg_unblock_range(
      Formatter* f,
      std::string_view param,
      std::string_view value,
      int generated_param);

  int dbg_set_sessions(
      Formatter* f,
      std::string_view param,
      std::string_view value,
      int generated_param);

  int dbg_clear_sessions(
      Formatter* f,
      std::string_view param,
      std::string_view value,
      int generated_param);
  ...
  struct AskDispatchEntry {
    asok_op_cmd_t op_cmd;
    uint32_t cmd_hash;
    uint32_t param_hash;  // or 0 for catch-all
    PgScrubber::asok_fn_t fn;
    int generated_param{0};
  };

  static inline const std::vector<AskDispatchEntry> asok_dispatch_tbl{
      {asok_op_cmd_t::set,  "block"_xhash, 0, &PgScrubber::dbg_block_range, 1},
      {asok_op_cmd_t::set,  "sessions"_xhash, 0, &PgScrubber::dbg_set_sessions, 1},
      {asok_op_cmd_t::set,  "repdeny"_xhash, 0, &PgScrubber::dbg_reserv_deny, 1},
      {asok_op_cmd_t::set,  "repdelay"_xhash, 0, &PgScrubber::dbg_reserv_delay, 1},

      {asok_op_cmd_t::clear,  "block"_xhash, 0, &PgScrubber::dbg_block_range, 0},
      {asok_op_cmd_t::clear,  "sessions"_xhash, 0, &PgScrubber::dbg_set_sessions, 0},

      {asok_op_cmd_t::unspecified,  "block"_xhash, 0, &PgScrubber::dbg_block_range, 1},
      {asok_op_cmd_t::unspecified,  "unblock"_xhash, 0, &PgScrubber::dbg_block_range, 0},
      {asok_op_cmd_t::unspecified,  "sessions"_xhash, 0, &PgScrubber::dbg_set_sessions, 1}
