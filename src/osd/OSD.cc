...
template <class MSG_TYPE>
void OSDService::queue_simple_scrub_event_msg(PG* pg,
                                              Scrub::scrub_prio_t with_priority)
{
  uint64_t cost_per_object = cct->_conf->osd_scrub_event_cost;
  queue_scrub_event_msg<MSG_TYPE>(pg, with_priority, cost_per_object);
}

void OSDService::queue_for_scrub(PG* pg, Scrub::scrub_prio_t with_priority)
{
  queue_simple_scrub_event_msg<PGScrub>(pg, with_priority);
}

void OSDService::queue_scrub_after_repair(PG* pg, Scrub::scrub_prio_t with_priority)
{
  queue_simple_scrub_event_msg<PGScrubAfterRepair>(pg, with_priority);
}
...
void OSDService::queue_for_scrub_resched(PG* pg, Scrub::scrub_prio_t with_priority)
{
  ...
  queue_simple_scrub_event_msg<PGScrubResched>(pg, with_priority);
}

void OSDService::queue_scrub_pushes_update(PG* pg, Scrub::scrub_prio_t with_priority)
{
  // Resulting scrub event: 'ActivePushesUpd'
  queue_simple_scrub_event_msg<PGScrubPushesUpdate>(pg, with_priority);
}

void OSDService::queue_scrub_chunk_free(PG* pg, Scrub::scrub_prio_t with_priority, uint64_t cost_per_object)
{
