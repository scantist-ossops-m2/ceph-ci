...
private:
  void __set_single_bit_no_bounderies_check(uint64_t offset);
  void __clr_single_bit_no_bounderies_check(uint64_t offset);
  ...
  constexpr static uint64_t      BITS_IN_WORD_SHIFT  = 6; // std::log2(BITS_IN_WORD);
