...
get_omap_iertr::future<
  crimson::os::FuturizedShardStore::omap_values_t>
...
static
get_omap_iertr::future<
  std::tuple<bool, crimson::os::FuturizedShardStore::omap_values_t>>
maybe_get_omap_vals(
  crimson::os::FuturizedShardStore* store,
  const crimson::os::CollectionRef& coll,
  const object_info_t& oi,
  ...
  object_stat_sum_t& delta_stats) const
{
  ...
  .safe_then_interruptible(
    [&osd_op] (crimson::os::FuturizedShardStore::omap_values_t&& vals) {
