...
public:
  ...
  class SeaShardStore : public FuturizedShardStore,
			public seastar::peering_sharded_service<SeaShardStore> {
  public:
    explicit SeaShardStore(
      std::string root,
  ...
  private:
	...
	return repeat_eagain([&, this, src, tname] {
	  ...
	  const_cast<SeaShardStore*>(this)->add_latency_sample(op_type,
...
public:
  ...
  SeaShardStore& get_local_shard_store() final {
...
private:
  ...
  bool is_test;
  seastar::sharded<SeaShardStore> shard_stores;
