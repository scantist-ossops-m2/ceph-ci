            ...
            with with_service(cephadm_module, MonitoringSpec('node-exporter')) as _, \
                ...
                alerting:
                  alertmanagers:
                    - scheme: https
                      http_sd_configs:
                        - url: https://[::1]:9000/sd/prometheus/sd-config?service=alertmanager
                          tls_config:
                ...
                scrape_configs:
                  - job_name: 'ceph'
                    honor_labels: true
                    http_sd_configs:
                    - url: https://[::1]:9000/sd/prometheus/sd-config?service=mgr-prometheus
                      tls_config:
                        ca_file: root_cert.pem

                  - job_name: 'node'
                    http_sd_configs:
                    - url: https://[::1]:9000/sd/prometheus/sd-config?service=node-exporter
                      tls_config:
                        ca_file: root_cert.pem

                  - job_name: 'haproxy'
                    http_sd_configs:
                    - url: https://[::1]:9000/sd/prometheus/sd-config?service=haproxy
                      tls_config:
                        ca_file: root_cert.pem
                """).lstrip()
