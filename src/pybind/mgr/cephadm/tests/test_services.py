            ...
            with with_service(cephadm_module, IscsiServiceSpec(service_id=pool,
                ...
                _run_cephadm.assert_called_with(
                    ...
                    [
                        ...
                        '--meta-json', f'{"{"}"service_name": "iscsi.{pool}", "ports": [{api_port}, 3260], "ip": null, "deployed_by": [], "rank": null, "rank_generation": null, "extra_container_args": null{"}"}',
                        '--config-json', '-', '--tcp-ports', '3456 3260'
                    ],
