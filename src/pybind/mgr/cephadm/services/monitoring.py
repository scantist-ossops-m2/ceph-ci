...
class GrafanaService(CephadmService):
    ...
    def generate_config(self, daemon_spec: CephadmDaemonDeploySpec) -> Tuple[Dict[str, Any], List[str]]:
        ...
        cert, pkey = self.prepare_certificates()
        config_file = {
            'files': {
    ...
    def prepare_certificates(self) -> Tuple[str, str]:
        ...
        # we only re-generate self signed certificates if the failed ones
        # were originaly generated by cephadm or they are empty
        if not (cert and pkey) \
           and ((org == 'Ceph' and cn == 'cephadm') or (org is None and cn is None)):
            ...
            and mgr/cephadm/grafana_key to valid certificates or run:
               > ceph orch daemon redeploy <grafana-daemon>
            to have cephadm generate self-signed grafana certificates.
            """
