...
class C_MDS_link_local_finish : public ServerLogContext {
  ...
  bool adjust_realm;
public:
  C_MDS_link_local_finish(Server *s, MDRequestRef& r, CDentry *d, CInode *ti, CInode *ri,
...
void Server::_link_local_finish(MDRequestRef& mdr, CDentry *dn, CInode *targeti, CInode *referenti,
...
class C_MDS_link_remote_finish : public ServerLogContext {
  ...
  version_t dpv;
public:
  C_MDS_link_remote_finish(Server *s, MDRequestRef& r, bool i, CDentry *d, CInode *ti, CInode *ri, CDentry *sd) :
...
void Server::_link_remote(MDRequestRef& mdr, bool inc, CDentry *dn, CInode *targeti, CDentry *straydn)
{
