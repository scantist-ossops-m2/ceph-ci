...
TEST_F(TestLibRBD, TestCloneEncryption)
{
  ...
  ASSERT_EQ(0, rbd_open(ioctx, name.c_str(), &image, NULL));
  bool passed;
  write_test_data(image, "aaaa", 0, 4, 0, &passed);
  ASSERT_TRUE(passed);
  ...
  ASSERT_EQ(0, rbd_encryption_load(
          child1, RBD_ENCRYPTION_FORMAT_LUKS1, &child1_opts,
          sizeof(child1_opts)));
  write_test_data(child1, "bbbb", 64 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
  ...
  ASSERT_EQ(0, rbd_encryption_load(
        child2, RBD_ENCRYPTION_FORMAT_LUKS2, &child2_opts,
        sizeof(child2_opts)));
  write_test_data(child2, "cccc", 128 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
  ...
  read_test_data(child3, "aaaa", 0, 4, 0, &passed);
  ASSERT_TRUE(passed);
  read_test_data(child3, "bbbb", 64 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
  read_test_data(child3, "cccc", 128 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
  ...
  read_test_data(child4, "aaaa", 0, 4, 0, &passed);
  ASSERT_TRUE(passed);
  read_test_data(child4, "bbbb", 64 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
  read_test_data(child4, "cccc", 128 << 20, 4, 0, &passed);
  ASSERT_TRUE(passed);
