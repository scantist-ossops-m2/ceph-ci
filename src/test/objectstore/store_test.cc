...
TEST_P(StoreTestSpecificAUSize, ZeroBlockDetectionSmallAppend) {
  ...
  }
  {
    ...
    ASSERT_EQ(logger->get(l_bluestore_zero_block_count_small), 1u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_bytes_small), 4096u);
...
TEST_P(StoreTestSpecificAUSize, ZeroBlockDetectionSmallOverwrite) {
  ...
  
  {
    ...
    ASSERT_EQ(logger->get(l_bluestore_write_small), 1u);
    ASSERT_EQ(logger->get(l_bluestore_write_small_bytes), 4096u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_count_small), 0u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_bytes_small), 0u);
...
TEST_P(StoreTestSpecificAUSize, ZeroBlockDetectionBigAppend) {
  ...
  
  {
    ...
    ASSERT_EQ(logger->get(l_bluestore_zero_block_count_big), 1u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_bytes_big), 4096u*2);
...
TEST_P(StoreTestSpecificAUSize, ZeroBlockDetectionBigOverwrite) {
  ...
  
  {
    ...
    ASSERT_EQ(logger->get(l_bluestore_write_big_bytes), 4096u*2);
    ASSERT_EQ(logger->get(l_bluestore_write_big_blobs), 1u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_count_big), 0u);
    ASSERT_EQ(logger->get(l_bluestore_zero_block_bytes_big), 0u);
