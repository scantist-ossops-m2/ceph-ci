                                       ...
                                       bool swift_slo)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_get_b, cur_end - cur_ofs);
...
void RGWGetObj::execute(optional_yield y)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_get, 1);
  ...
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_get_b, end-ofs);
  ...
  rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_get_lat, s->time_elapsed());
...
void RGWListBuckets::execute(optional_yield y)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_list_buckets, 1);
  ...
  rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_list_buckets_lat, s->time_elapsed());
}
...
void RGWListBucket::execute(optional_yield y)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_list_obj, 1);
  rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_list_obj_lat, s->time_elapsed());
}
...
void RGWDeleteBucket::execute(optional_yield y)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_del_bucket, 1);
  rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_del_bucket_lat, s->time_elapsed());
...
void RGWPutObj::execute(optional_yield y)
{
  ...
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_put, 1);

  // report latency on return
  auto put_lat = make_scope_guard([&] {
      rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_put_lat, s->time_elapsed());
    });
  ...
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_put_b, s->obj_size);
...
void RGWDeleteObj::execute(optional_yield y)
{
  ...
  if (!rgw::sal::Object::empty(s->object.get())) {
    ...
    auto user_bucket_counters = rgw::op_counters::get(s);
    rgw::op_counters::inc(user_bucket_counters, l_rgw_op_del_obj, 1);
    rgw::op_counters::inc(user_bucket_counters, l_rgw_op_del_obj_b, obj_size);
    rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_del_obj_lat, s->time_elapsed());
...
void RGWCopyObj::execute(optional_yield y)
{
  ...
  auto user_bucket_counters = rgw::op_counters::get(s);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_copy_obj, 1);
  rgw::op_counters::inc(user_bucket_counters, l_rgw_op_copy_obj_b, obj_size);
  rgw::op_counters::tinc(user_bucket_counters, l_rgw_op_copy_obj_lat, s->time_elapsed());
}
